...
% T is given, it is used as test set for FEATEVAL. For K = 0, the optimal
% feature set (corresponding to the maximum value of FEATEVAL) is returned.  
% The result W can be used for selecting features using B*W.  In R, the 
% search is reported step by step as:
% 
...
% $Id: featself.m,v 1.13 2003/11/23 22:32:12 bob Exp $
